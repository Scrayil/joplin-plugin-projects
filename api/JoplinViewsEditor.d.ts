 ...
 *
 * - `showEditorPlugin` and `toggleEditorPlugin` commands.ts. Additionally you can use these commands.ts
 *   to display your editor via `joplin.commands.ts.execute('showEditorPlugin')`. This is not always
